...
local SettingsSlider = {
    ...
    LeftArrow = { Dictionary = "mpleaderboard", Texture = "leaderboard_male_icon", X = 220, Y = 0, Width = 33, Height = 33 },
    RightArrow = { Dictionary = "mpleaderboard", Texture = "leaderboard_female_icon", X = 400, Y = 0, Width = 33, Height = 33 },
}
