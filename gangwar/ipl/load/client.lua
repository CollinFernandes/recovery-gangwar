Citizen.CreateThread(function()
    ...
    ImportCEOGarage2.Style.Set(ImportCEOGarage2.Part.Garage1, ImportCEOGarage2.Style.marble)
    ImportCEOGarage2.Lighting.Set(ImportCEOGarage2.Part.Garage1,ImportCEOGarage2.Lighting.style2, true)
    ImportCEOGarage2.Numbering.Set(ImportCEOGarage2.Part.Garage1, ImportCEOGarage1.Numbering.Level1.style1)
